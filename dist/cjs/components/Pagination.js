        ...
        if (offset === undefined) {
            ...
            return ((0, jsx_runtime_1.jsx)(react_1.Fragment, { children: firstNumber_1 && lastNumber_1 ? ((0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [showFirstNumberAlways && ((0, jsx_runtime_1.jsx)(PaginationItem_1.default, { onClick: function () { return currentPage.set(firstNumber_1); }, className: classNames === null || classNames === void 0 ? void 0 : classNames.item, activeClassName: classNames === null || classNames === void 0 ? void 0 : classNames.itemActive, active: firstNumber_1 === currentPage.get, children: firstNumber_1 }, firstNumber_1)), navPrevCustom && currentPage.get > offsetToHideStart_1 + 1 && ((0, jsx_runtime_1.jsx)("li", { onClick: function () {
                            ...
                            if (!numberIsDisabled && pageNumber !== currentPage.get) {
                                ...
                                if (showNumber) {
                                    return ((0, jsx_runtime_1.jsx)(PaginationItem_1.default, { onClick: function () { return currentPage.set(pageNumber); }, className: classNames === null || classNames === void 0 ? void 0 : classNames.item, children: pageNumber }, pageNumber));
                                }
                                return null;
                            }
                        ...
                        }), navNextCustom && currentPage.get <= lastNumber_1 - offsetToHideEnd_1 - 1 && ((0, jsx_runtime_1.jsx)("li", { onClick: function () {
                            ...
                            }, className: (classNames === null || classNames === void 0 ? void 0 : classNames.navNextCustom) ? classNames.navNextCustom : undefined, children: navNextCustom.content })), showLastNumberAlways && lastNumber_1 !== firstNumber_1 && ((0, jsx_runtime_1.jsx)(PaginationItem_1.default, { onClick: function () { return currentPage.set(lastNumber_1); }, className: classNames === null || classNames === void 0 ? void 0 : classNames.item, activeClassName: classNames === null || classNames === void 0 ? void 0 : classNames.itemActive, active: lastNumber_1 === currentPage.get, children: lastNumber_1 }, lastNumber_1))] })) : null }));
        }
    }
    var pageNumbers = (0, generateNumArr_1.default)(1, Math.ceil(totalEntries / entriesPerPage));
    return ((0, jsx_runtime_1.jsxs)("ul", { className: classNames === null || classNames === void 0 ? void 0 : classNames.wrapper, children: [navStart && pageNumbers.length > 1 && ((0, jsx_runtime_1.jsx)("li", { className: (classNames === null || classNames === void 0 ? void 0 : classNames.navStart) ? classNames.navStart : undefined, onClick: function () { return currentPage.set(1); }, children: navStart })), navPrev && pageNumbers.length > 1 && ((0, jsx_runtime_1.jsx)("li", { className: (classNames === null || classNames === void 0 ? void 0 : classNames.navPrev) ? classNames.navPrev : undefined, onClick: function () { return currentPage.get > 1 && currentPage.set(currentPage.get - 1); }, children: navPrev })), generatePagination(pageNumbers, currentPage, offset), navNext && pageNumbers.length > 1 && ((0, jsx_runtime_1.jsx)("li", { className: (classNames === null || classNames === void 0 ? void 0 : classNames.navNext) ? classNames.navNext : undefined, onClick: function () { return currentPage.get < pageNumbers.length && currentPage.set(currentPage.get + 1); }, children: navNext })), navEnd && pageNumbers.length > 1 && ((0, jsx_runtime_1.jsx)("li", { className: (classNames === null || classNames === void 0 ? void 0 : classNames.navEnd) ? classNames.navEnd : undefined, onClick: function () { return currentPage.set(pageNumbers[pageNumbers.length - 1]); }, children: navEnd }))] }));
};
