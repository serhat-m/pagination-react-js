...
const App = () => {
  ...
  // Generate dummy data
  const dataList = generateTestData(700, i => ({ id: i, name: `Test ${i}`, gender: i % 2 ? "Female" : "Male", position: `Position ${i}`, email: `test${i}@test.com` }))
    ...
    <div className="container">
      <header className="mb-2">
        <div className="select-wrapper max-elements">
          ...
          <select name="max-elements" id="max-elements" onChange={e => { currentPage.set(1); entriesPerPage.set(Number(e.target.value)); }}>
      ...
      <div className="example-table">
        <table>
          <thead>
            <tr>
              <th title="Id" className="table-id">Id</th>
              <th title="Name" className="table-name">Name</th>
              <th title="Gender" className="table-gender">Gender</th>
              <th title="Position" className="table-position">Position</th>
              <th title="E-Mail" className="table-email">E-Mail</th>
            </tr>
          </thead>
          <tbody>
            {
